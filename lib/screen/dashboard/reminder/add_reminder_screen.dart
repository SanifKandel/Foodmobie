...
class AddReminderScreen extends StatefulWidget {
  ...
  @override
  State<AddReminderScreen> createState() => AddReminderScreenState();
}
...
class AddReminderScreenState extends State<AddReminderScreen> {
  ...
  _saveReminder() async {
    ...
    int status = await ReminderRepositoryImpl().createReminder(_img, reminders);
    _showMessage(status);
  }
    ...
    if (status > 0) {
      AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            body: 'Dear, User your reminder has been added successfully!'),
      );
      showSnackbar(context, 'Reminder Added Successfully', Colors.green);
    } else {
      showSnackbar(context, 'Error Adding Reminder', Colors.red);
    }
  }
